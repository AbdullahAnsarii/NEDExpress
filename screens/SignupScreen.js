  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <FormButton
        ...
        onPress={errors ? () => Alert.alert("NED Express", "Please provide valid credential!") : () => registerHandle(user.name, user.email, user.password, user.cpassword, user.rollno, user.department, user.contactno)}
      />
